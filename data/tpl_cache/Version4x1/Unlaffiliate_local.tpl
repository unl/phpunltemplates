<!DOCTYPE html>
<html class="no-js" lang="en"><!-- InstanceBegin template="/Templates/unlaffiliate_local.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<!--
    ...
    $Id: unlaffiliate_local.dwt | 6edb0e1ee94038935f3821c6ce15dfd5c217b2e2 | Tue Dec 1 17:08:56 2015 -0600 | Kevin Abel  $
-->
    ...
    <div id="wdn_wrapper">
        ...
        <header id="header" role="banner" class="wdn-content-slide wdn-band">
            <div id="wdn_header_top">
                <span id="wdn_institution_title"><!-- InstanceBeginEditable name="sitebranding_affiliate" --><a href="http://www.unl.edu" title="University of Nebraska&ndash;Lincoln">An affiliate of the University of Nebraska&ndash;Lincoln</a><!-- InstanceEndEditable --></span>
            ...
            <div id="wdn_logo_lockup">
                <div class="wdn-inner-wrapper">
                    ...
                    <span id="wdn_site_title"><!-- InstanceBeginEditable name="titlegraphic" -->Title of my site<!-- InstanceEndEditable --></span>
                </div>
            </div>
        </header>
